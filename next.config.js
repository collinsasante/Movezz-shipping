    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=()" },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://apis.google.com https://*.firebaseapp.com https://translate.googleapis.com https://static.cloudflareinsights.com",
              ...
              "frame-src https://*.firebaseapp.com https://accounts.google.com https://keepup.store https://*.keepup.store https://www.youtube.com https://youtube.com",
              "object-src 'none'",
              "base-uri 'self'",
            ].join("; "),
          },
