...
function applySecurityHeaders(response: NextResponse): NextResponse {
  ...
  response.headers.set(
    ...
    [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://apis.google.com https://translate.googleapis.com https://static.cloudflareinsights.com",
      ...
      "font-src 'self'",
      "frame-src https://keepup.store https://*.keepup.store https://*.firebaseapp.com https://accounts.google.com https://www.youtube.com https://youtube.com",
